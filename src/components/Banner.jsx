...
function Banner() {
  ...
  useEffect(function () {
    (function () {
      axios
        .get(
          "https://api.themoviedb.org/3/trending/all/week?language=en-US&api_key=c329e49ea66541c60669781b65c43433"
        )
        .then((res) => {
  ...
  return (
    <>
      {bannerMovie === " " ? (
        ...
        <div
          className={`h-[40vh]  bg-center bg-cover  flex items-end  md:h-[60vh]`}
          style={{
